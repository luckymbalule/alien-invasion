...
This has been built with deliberate intentions to serve as a sandbox for implementing software design patterns, deterministic mathematics for the layout logic, and Test-Driven Development (TDD) in an interactive game.
